# Kaggle Demo Notebooks

## Links

| Demo | Topic | Link |
|---|---|---|
| Demo 1 | AI Traffic Classification | https://www.kaggle.com/code/guopingtan/fmi-demo1-traffic-classification |
| Demo 2 | Video QoE Optimization | https://www.kaggle.com/code/guopingtan/fmi-demo2-qoe-optimization |
...
Open any link to view pre-executed results. Click **Run All** to re-execute (requires Kaggle login).

## Classroom Flow

- **Session 1**: Demo 1 (10 min) -> Demo 2 (12 min)
- **Session 2**: Demo 5 (10 min) -> Demo 6 (8 min) -> Demo 7 (8 min)
- **Brief mentions**: Demo 3, Demo 4
